@extends('cms.index')
@section('judul')
SIBESTRO - Detail Wawancara SMA
@endsection
@section('detail-wawancara-sma')
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="#">Wawancara</a></li>
              <li class="breadcrumb-item active">Detail Wawancara SMA</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <table width="100%" style="padding:4px;">
                ...
                <img src="{{ URL::to('/') }}/dist/img/fotodiri/{{$fd->nama_file}}"style="height:200px;width:100px">
                @endforeach
                </div>
                </div>
                <br>
              ...
              <table class="table table-bordered table-striped">
                ...
                @foreach($fotorumah as $fr)
                  <div class="col-md-2">
                    <div>
                    <a href="{{ URL::to('/') }}/dist/img/fotorumah/{{$fr->nama_file}}" data-toggle="lightbox" data-title="{{$fr->jenis}}" data-gallery="gallery">
                          <img src="{{ URL::to('/') }}/dist/img/fotorumah/{{$fr->nama_file}}" style="height:200px;width:200px" class="img-fluid mb-2" alt="{{$fr->jenis}}"/>
                    </a> </div>
                   </div>
                @endforeach
                </div>
                ...
                @foreach($buktipenerimaan as $bktp)
                  <div class="col-md-2">
                    <div>
                    <a href="{{ URL::to('/') }}/dist/img/buktipenerimaan/{{$bktp->nama_file}}" data-toggle="lightbox" data-title="Bukti Penerimaan" data-gallery="gallery">
                          <img src="{{ URL::to('/') }}/dist/img/buktipenerimaan/{{$bktp->nama_file}}" style="height:200px;width:200px" class="img-fluid mb-2" alt="{{$fr->jenis}}"/>
                    </a> </div>
                   </div>
                @endforeach
                </div>
                ...
                <embed src="{{ URL::to('/') }}/berkas/ukt/{{$bu->nama_file}}#toolbar=0&navpanes=0&scrollbar=0" type="application/pdf"width="70%" height="1000px"/>
                @endforeach
                <br>
                ...
                @foreach($berkasidentitas as $bi)
                  <embed src="{{ URL::to('/') }}/berkas/identitas/{{$bi->nama_file}}#toolbar=0&navpanes=0&scrollbar=0" type="application/pdf"width="70%" height="1000px"/>
                @endforeach
                <br>
                <br>
                ...
                <embed src="{{ URL::to('/') }}/berkas/sktm/{{$SKTM->nama_file}}#toolbar=0&navpanes=0&scrollbar=0" type="application/pdf"width="70%" height="1000px"/>
                @endforeach
                <br>
                <br>
                ...
                @foreach($buktitagihan as $bt)
                  <div class="col-md-4">
                    <div>
                    <h6>{{$bt->jenis}}</h6>
                    <embed src="{{ URL::to('/') }}/berkas/tagihan/{{$bt->nama_file}}#toolbar=0&navpanes=0&scrollbar=0" type="application/pdf" width="100%"height="500px"/>
                    </div>
                   </div>
                @endforeach
                </div>
                ...
                @foreach($bansos as $bss)
                  <div class="col-md-4">
                    <div>
                    <h6>{{$bss->jenis}}</h6>
                    <embed src="{{ URL::to('/') }}/berkas/bansos/{{$bss->nama_file}}#toolbar=0&navpanes=0&scrollbar=0" type="application/pdf" width="100%"height="500px"/>
                    </div>
                   </div>
                @endforeach
                </div>
                ...
                @foreach($ijazahskhu as $ijz)
                  <div class="col-md-4">
                    <div>
                    <h6>{{$bss->jenis}}</h6>
                    <embed src="{{ URL::to('/') }}/berkas/ijazahskhu/{{$ijz->nama_file}}#toolbar=0&navpanes=0&scrollbar=0" type="application/pdf" width="100%"height="500px"/>
                    </div>
                   </div>
                @endforeach
                </div>
                ...
                <embed src="{{ URL::to('/') }}/berkas/penghasilan/{{$phs->nama_file}}#toolbar=0&navpanes=0&scrollbar=0" type="application/pdf"width="70%" height="1000px"/>
                @endforeach
                <br>
                <br>
                ...
                <embed src="{{ URL::to('/') }}/berkas/rapor/{{$rpr->nama_file}}#toolbar=0&navpanes=0&scrollbar=0" type="application/pdf"width="70%" height="1000px"/>
               @endforeach
                <br>
                <br>
                ...
                <embed src="{{ URL::to('/') }}/berkas/suratpernyataan/{{$srp->nama_file}}#toolbar=0&navpanes=0&scrollbar=0" type="application/pdf"width="70%" height="1000px"/>
                @endforeach
                <br>
                <br>
