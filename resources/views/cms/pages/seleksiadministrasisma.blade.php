@extends('cms.index')
@section('seleksi-administrasi-sma')
@section('judul')
SIBESTRO - Seleksi Administrasi SMA
@endsection
            ...
            <div class="card">
              ...
              <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    @if($PESERTASMA->status_daftar=='Terdaftar')
                ...
                <!-- confirmModal Hapus  -->
                    <a href="{{route('detail-seleksi-administrasi-sma',Crypt::encrypt($PESERTASMA->id))}}"><button class="btn btn-info" style="padding:3px 6px;">Detail</button></a>
                      ...
                      <div class="modal-dialog">
                          <div class="modal-content">
                              ...
                              <div class="modal-body">
                                  <a align="center" style="margin:0;">Anda Yakin Ingin Meloloskan {{$PESERTASMA->name}} Ke Tahap Selanjutnya?</a>
                              </div>
                              <div class="modal-footer">
                              <a href="{{route('lolos-seleksi-administrasi-sma',$PESERTASMA->id)}}"><button type="button" name="ok_button" id="ok_button" class="btn btn-success btn-sm">Yakin</button></a>
                    ...
                    <div id="tidaklolosModal{{$PESERTASMA->id}}" class="modal fade" role="dialog">
                      <div class="modal-dialog">
                          <div class="modal-content">
                              ...
                              <div class="modal-body">
                                  <a align="center" style="margin:0;">Anda Yakin Tidak Meloloskan {{$PESERTASMA->name}} Ke Tahap Selanjutnya?</a>
                              </div>
                              <div class="modal-footer">
                              <a href="{{route('tidak-lolos-seleksi-administrasi-sma',$PESERTASMA->id)}}"><button type="button" name="ok_button" id="ok_button" class="btn btn-success btn-sm">Yakin</button></a>
                                  <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">Cancel</button>
                              </div>
                          </div>
                      </div>
