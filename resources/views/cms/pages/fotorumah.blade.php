        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Foto Rumah</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Upload Foto Rumah</h3>
              </div>
              
              <!-- /.card-header -->
              <div class="card-body">
              
              <form action ="{{route('tambah-foto-rumah')}}" method="POST" enctype="multipart/form-data">
              {{csrf_field()}}
              <div class="form-group">
                                ...
                                <select class="form-control"  id="recipient-name"required name="jenis">
                                    ...
                                    <option value="Teras">Kamar Pribadi</option>
                                </select>
            </div>
              <div class="form-group">
                <label for="recipient-name" class="col-form-label">Upload Foto Rumah (.jpeg,.png)</label>
        ...
        <!-- /.row -->
            ...
            <div class="card card-success">
              <div class="card-header">
                <h4 class="card-title">List Foto Rumah</h4>
              </div>
              <div class="card-body">
                <div class="row">
                @foreach($data as $d)
                  <div class="col-sm-2">
                    <div>
                    <a href="{{ URL::to('/') }}/dist/img/fotorumah/{{$d->nama_file}}" data-toggle="lightbox" data-title="{{$d->jenis}}" data-gallery="gallery">
                      <img src="{{ URL::to('/') }}/dist/img/fotorumah/{{$d->nama_file}}" style="height:200px;width:200px" class="img-fluid mb-2" alt="{{$d->jenis}}"/>
                    </a>
                    </div>
                  ...
                  <div id="confirmModal{{$d->id}}" class="modal fade" role="dialog">
                      <div class="modal-dialog">
                          <div class="modal-content">
                              ...
                              <a href="{{route('delete-foto-rumah',$d->id)}}"><button type="button" name="ok_button" id="ok_button" class="btn btn-danger btn-sm">Hapus</button></a>
