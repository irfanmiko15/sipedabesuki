          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="form-group">
                <label for="recipient-name" class="col-form-label">Upload Bukti Penerimaan (.jpeg,.png)</label>
            ...
            <div class="card card-success">
              ...
              <div class="card-body">
                ...
                @foreach($data as $d)
                  <div class="col-sm-2">
                    <div>
                    <a href="{{ URL::to('/') }}/dist/img/buktipenerimaan/{{$d->nama_file}}" data-toggle="lightbox" data-title="bukti penerimaan" data-gallery="gallery">
                      <img src="{{ URL::to('/') }}/dist/img/buktipenerimaan/{{$d->nama_file}}" style="height:200px;width:200px" class="img-fluid mb-2" alt="bukti penerimaan"/>
                    </a>
                    </div>
