          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Upload Surat Keterangan Tidak Mampu</h3>
              </div>
              
              <!-- /.card-header -->
              <div class="card-body">
              
              <form action ="{{route('tambah-berkas-sktm')}}" method="POST" enctype="multipart/form-data">
              {{csrf_field()}}

              <div class="form-group">
                <label for="recipient-name" class="col-form-label">Upload Surat Keterangan Tidak Mampu (.pdf)</label>
              ...
              @endif
                ...
                <div class="container">
                <div class="row">
                <embed src="{{ URL::to('/') }}/berkas/sktm/{{$d->nama_file}}#toolbar=0&navpanes=0&scrollbar=0" type="application/pdf"width="60%" height="1000px"/>
                ...
                <div id="confirmModal{{$d->id}}" class="modal fade" role="dialog">
                      <div class="modal-dialog">
                          <div class="modal-content">
                              ...
                              <a href="{{route('delete-berkas-sktm',$d->id)}}"><button type="button" name="ok_button" id="ok_button" class="btn btn-danger btn-sm">Hapus</button></a>
