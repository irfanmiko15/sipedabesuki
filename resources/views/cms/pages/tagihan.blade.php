      ...
      <div class="container-fluid">
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Upload Berkas Tagihan</h3>
              </div>
              
              <!-- /.card-header -->
              <div class="card-body">
              
              <form action ="{{route('tambah-berkas-tagihan')}}" method="POST" enctype="multipart/form-data">
              {{csrf_field()}}
              <div class="form-group">
                                ...
                                <select class="form-control"  id="recipient-name"required name="jenis">
                                    ...
                                    <option value="Tagihan Listrik">Tagihan Listrik/Pembelian Token Listrik</option>
                                    <option value="Tagihan PDAM">Tagihan PDAM</option>
                                    <option value="Tagihan PBB">Tagihan PBB</option>
        ...
        <!-- /.row -->
            ...
            <div class="card card-success">
              <div class="card-header">
                <h4 class="card-title">List Dokumen Tagihan</h4>
              </div>
              <div class="card-body">
                <div class="row">
                @foreach($data as $d)
                  <div class="col-md-4">
                    ...
                    <h5>{{$d->jenis}}</h5>
                    <br>
                    <embed src="{{ URL::to('/') }}/berkas/tagihan/{{$d->nama_file}}#toolbar=0&navpanes=0&scrollbar=0" type="application/pdf" width="100%"height="500px"/>
                    </div>
                  ...
                  <div id="confirmModal{{$d->id}}" class="modal fade" role="dialog">
                      <div class="modal-dialog">
                          <div class="modal-content">
                              ...
                              <a href="{{route('delete-berkas-tagihan',$d->id)}}"><button type="button" name="ok_button" id="ok_button" class="btn btn-danger btn-sm">Hapus</button></a>
