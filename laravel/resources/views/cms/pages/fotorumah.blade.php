            ...
            <div class="card card-success">
              ...
              <div class="card-body">
                ...
                @foreach($data as $d)
                  <div class="col-sm-2">
                    <div>
                    <a href="{{asset('dist/img/fotorumah')}}/{{$d->nama_file}}" data-toggle="lightbox" data-title="{{$d->jenis}}" data-gallery="gallery">
                      <img src="{{ asset('dist/img/fotorumah')}}/{{$d->nama_file}}" style="height:200px;width:200px" class="img-fluid mb-2" alt="{{$d->jenis}}"/>
                    </a>
                    </div>
