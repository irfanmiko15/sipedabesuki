              ...
              <br>
                <table id="example2" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <a href="{{asset('dist/img/prestasi')}}/{{$d->nama_file}}" data-toggle="lightbox" data-title="{{$d->prestasi}}" data-gallery="gallery">
                      <img src="{{asset('dist/img/prestasi')}}/{{$d->nama_file}}" style="height:200px;width:200px" class="img-fluid mb-2" alt="{{$d->prestasi}}"/>
                    </a>
                    </div></td>
