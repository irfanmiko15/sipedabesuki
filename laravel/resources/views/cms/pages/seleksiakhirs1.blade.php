@extends('cms.index')
@section('seleksi-akhir-s1')
@section('judul')
SIBESTRO - Seleksi Akhir S1
@endsection
<section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Seleksi Akhir S1</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
          
              <li class="breadcrumb-item active">Seleksi Akhir S1</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              ...
              <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    @if($PESERTAS1->seleksi_akhir=='Lolos')
                    <td> <span class="badge badge-pill  badge-success">{{$PESERTAS1->seleksi_akhir}}</span></td>
                  
                    @elseif($PESERTAS1->seleksi_akhir=='Tidak Lolos')
                    <td> <span class="badge badge-pill  badge-danger">{{$PESERTAS1->seleksi_akhir}}</span></td>
                    @else
                    ...
                    <td>
                    @if($PESERTAS1->seleksi_akhir==null)
                      ...
                      <div class="modal-dialog">
                          <div class="modal-content">
                              ...
                              <div class="modal-body">
                                  <a align="center" style="margin:0;">Anda Yakin Ingin Meloloskan {{$PESERTAS1->name}}?</a>
                              </div>
                              <div class="modal-footer">
                              <a href="{{route('lolos-seleksi-akhir-s1',$PESERTAS1->id)}}"><button type="button" name="ok_button" id="ok_button" class="btn btn-success btn-sm">Yakin</button></a>
                    ...
                    <div id="tidaklolosModal{{$PESERTAS1->id}}" class="modal fade" role="dialog">
                      <div class="modal-dialog">
                          <div class="modal-content">
                              ...
                              <div class="modal-body">
                                  <a align="center" style="margin:0;">Anda Yakin Tidak Meloloskan?</a>
                              </div>
                              <div class="modal-footer">
                              <a href="{{route('tidak-lolos-seleksi-akhir-s1',$PESERTAS1->id)}}"><button type="button" name="ok_button" id="ok_button" class="btn btn-success btn-sm">Yakin</button></a>
                                  <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">Cancel</button>
                              </div>
                          </div>
                      </div>
