          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Upload Identitas</h3>
              </div>
              
              <!-- /.card-header -->
              <div class="card-body">
             
              <form action ="{{route('tambah-berkas-identitas')}}" method="POST" enctype="multipart/form-data">
              {{csrf_field()}}

              <div class="form-group">
                @if(Auth::user()->role=='S1')
                <label for="recipient-name" class="col-form-label">Upload Identitas(KTP diri,KTP Orang Tua,KK) (.pdf)</label>
                @else
                <label for="recipient-name" class="col-form-label">Upload Identitas(Kartu Pelajar,KTP Orang Tua,KK) (.pdf)</label>
                @endif
              ...
              @endif
                ...
                <div class="container">
                <div class="row">
                <embed src="{{asset('berkas/identitas')}}/{{$d->nama_file}}#toolbar=0&navpanes=0&scrollbar=0" type="application/pdf"width="60%" height="1000px"/>
                ...
                <div id="confirmModal{{$d->id}}" class="modal fade" role="dialog">
                      <div class="modal-dialog">
                          <div class="modal-content">
                              ...
                              <a href="{{route('delete-berkas-identitas',$d->id)}}"><button type="button" name="ok_button" id="ok_button" class="btn btn-danger btn-sm">Hapus</button></a>
