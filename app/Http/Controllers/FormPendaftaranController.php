...
class FormPendaftaranController extends Controller
{
    ...
    public function create(Request $request){
        ...
        $file->move(public_path('berkas/formpendaftaran'), $new_name);
    ...
    public function delete($id){
        ...
        $datas=$data->first();
            if(file_exists(public_path("berkas/formpendaftaran/$datas->nama_file"))){
                unlink(public_path("berkas/formpendaftaran/$datas->nama_file"));
                $data->delete();
